        ...
        <div :class="'col-'+(store.show_filters?9:store.list_view_width)">
            <Panel class="is-small">
                ...
                <template #icons>
                    ...
                    <Button data-testid="doctorpatientappoinments-list-create"
                            class="p-button-sm"
                            @click="store.toForm()">
                    ...
                    <Button data-testid="doctorpatientappoinments-list-reload"
                            class="p-button-sm"
                            @click="store.getList()">
                    ...
                    <Button v-if="root.assets && root.assets.module
                        ...
                        class="p-button-sm"
                        data-testid="doctorpatientappoinments-create-menu"
