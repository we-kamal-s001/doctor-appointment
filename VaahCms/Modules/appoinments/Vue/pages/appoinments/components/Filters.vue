    ...
    <div class="col-3" v-if="store.show_filters">
            ...
            <Panel class="is-small">
                ...
                <template #icons>
                    ...
                    <div class="p-inputgroup">
                        ...
                        <Button data-testid="doctorpatientappoinments-hide-filter"
                                class="p-button-sm"
            ...
            <VhFieldVertical >
                ...
                <Dropdown
                    ...
                    :disabled="store.item.id"
                    v-model="store.query.filter.sort_doctor"
                    option-label="name"
                    class="w-full"
                    option-value="id"
                    showClear
             ...
             <RadioButton name="sort-none"
                                 inputId="sort-none"
                                 data-testid="doctorpatientappoinments-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-all"
                                 inputId="active-all"
                                 value="null"
                                 data-testid="doctorpatientappoinments-filters-active-all"
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-true"
                                 inputId="active-true"
                                 data-testid="doctorpatientappoinments-filters-active-true"
                                 value="true"
                                 v-model="store.query.filter.is_active" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 ...
                                 data-testid="doctorpatientappoinments-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
