...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-appoinments';
        ...
        */
        ...
        return view('appoinments::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('appoinments.name'),
            'version' => config('settings.global.appoinments_version')??config('appoinments.version'),
            'is_dev' => config('appoinments.is_dev'),
        ];
